...
function RequestBox() {
  ...
  <div className="container mx-auto">
    ...
    <div className="inline-flex w-full">
      ...
      <input type="text" className="w-full py-2 px-1" placeholder="people/1/" />
    ...
    <small>Need a hint? try{' '}
      <a href="#"><i>people/1/</i></a> or {' '}
      <a href="#"><i>planets/3/</i></a> or {' '}
      <a href="#"><i>starships/9/</i></a>
    </small>
      ...
      <div className="relative overflow-hidden mb-8">
        <div className="rounded overflow-hidden border border-gray-400 p-4">
          <div className="overscroll-auto overflow-auto h-64 bg-gray-300 text-gray-700 p-4">
            <pre id="interactive_output" className="overscroll-auto">
{`{
    "name": "Luke Skywalker",
    "height": "172",
    "mass": "77",
